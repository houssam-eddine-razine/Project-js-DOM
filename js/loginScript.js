...
const confirmPasswordEl = document.querySelector('#passc');
...
/*usernameEl.addEventListener('input',function()
{
    if(usernameEl.value.length<3 || usernameEl.value.length>25 ){
        usernameEl.style.border='red solid 2px';
    }else{
        usernameEl.style.border='lightgreen solid 2px'
    }
})*/
const checkUsername = () => {
